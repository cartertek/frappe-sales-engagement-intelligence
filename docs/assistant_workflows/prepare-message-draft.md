...
- Do not use phrases such as “this work,” “this kind of work,” or “work like this” unless the preceding message clearly describes what they refer to. The referent must be understandable from the message itself, not only from the source material, company category, role title, or the writer’s private context.
