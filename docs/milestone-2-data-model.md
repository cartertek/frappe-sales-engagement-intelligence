...
Milestone 2 adds informational SEI context fields to Frappe CRM records through an idempotent patch.
...
- The five SEI DocTypes exist.
- The CRM Lead and CRM Deal custom fields exist.
- The SEI thesis seed records exist.
- The Sales Engagement and Intelligence workspace shows the SEI DocTypes.
- ERPNext still loads.
