...
app_include_js = [
    ...
    "/assets/sales_engagement_intelligence/js/sei_prospect_cache_bypass.js",
]
        ...
        "filters": [
            [
                ...
                [
                    ...
                    "CRM Lead-sei_research_arena",
                    "CRM Lead-sei_playbook",
                    "CRM Lead-sei_qualification_summary",
                    "CRM Deal-sei_tab",
                    "CRM Deal-sei_prospect",
                    "CRM Deal-sei_research_arena",
                    "CRM Deal-sei_playbook",
