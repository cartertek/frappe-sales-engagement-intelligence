...
PLAYBOOKS = [
    {
        ...
        "default_thesis": "Agency Technical Reinforcement",
        "default_offer": "White-label engineering support / technical rescue call",
        "prospect_types": "Agency, Ecosystem Partner, Referral Partner",
        "source_arenas": "Agency directories, partner ecosystems, referral networks, service-provider communities",
        "likely_contact_roles": "Founder, operations lead, delivery lead, account lead",
    ...
    },
    {
        ...
        "default_thesis": "Hiring-Gap Substitution",
        "default_offer": "Scoped diagnostic / focused implementation sprint",
        "prospect_types": "Startup, SMB, Enterprise",
        "source_arenas": "Job boards, company career pages, community hiring posts, role reposts",
        "likely_contact_roles": "CTO, VP Engineering, engineering manager, founder/operator, product lead",
    ...
    },
    {
        ...
        "default_thesis": "Post-Launch Stabilization",
        "default_offer": "Production-readiness review / bug and integration cleanup",
        "prospect_types": "Startup, SMB, Enterprise",
        "source_arenas": "Launch posts, Product Hunt, release notes, support forums, social announcements",
        "likely_contact_roles": "Founder, CTO, product lead, engineering lead",
    ...
    },
    {
        ...
        "default_thesis": "Project Rescue",
        "default_offer": "Technical diagnostic / stabilization sprint",
        "prospect_types": "Startup, SMB, Enterprise, Community Lead, Directory Lead",
        "source_arenas": "GitHub, public forums, issue trackers, communities, product feedback surfaces",
        "likely_contact_roles": "CTO, technical lead, founder, operations owner, product owner",
    ...
    },
    {
        ...
        "prospect_types": "Agency, Ecosystem Partner, Referral Partner",
        "source_arenas": "Partner directories, consultant networks, local business networks, adjacent service ecosystems",
        "likely_contact_roles": "Agency owner, designer, MSP owner, fractional CTO, consultant, advisor",
    ...
    },
    {
        ...
        "default_thesis": "Technical Diagnostic / Second Set of Eyes",
        "default_offer": "Depends on current signal",
        "prospect_types": "Agency, Startup, SMB, Enterprise, Ecosystem Partner, Directory Lead, Community Lead, Procurement Lead, Referral Partner, Other",
        "source_arenas": "Prior SEI records, CRM history, renewed public signals, follow-up windows",
        "likely_contact_roles": "Original contact, new role owner, founder, CTO, operations lead",
...
TEMPLATES = [
    {
        ...
        "contact_role": "Founder / Operations Lead / Delivery Lead",
    ...
    },
    {
        ...
        "channel": "Email",
        "contact_role": "CTO / Engineering Manager / Founder",
    ...
    },
    {
        ...
        "channel": "Email",
        "contact_role": "Founder / CTO / Product Lead",
    ...
    },
    {
        ...
        "channel": "Email",
        "contact_role": "Founder / CTO / Product Owner",
    ...
    },
    {
        ...
        "thesis": "Agency Technical Reinforcement",
        "channel": "Email",
        "contact_role": "Agency Owner / Consultant / Advisor",
    ...
    },
    {
        ...
        "channel": "Email",
        "contact_role": "Original Contact / Current Owner",
...
def seed_playbooks() -> None:
    for row in PLAYBOOKS:
        rules = row["rules"]
        values = {key: value for key, value in row.items() if key != "rules"}
        values["active"] = 1
        if values.get("default_thesis") and not frappe.db.exists("SEI Thesis", values["default_thesis"]):
            values["default_thesis"] = None
        if frappe.db.exists("SEI Playbook", values["playbook_name"]):
            doc = frappe.get_doc("SEI Playbook", values["playbook_name"])
            doc.update(values)
        else:
            doc = frappe.get_doc({"doctype": "SEI Playbook", **values})
...
def seed_message_templates() -> None:
    for row in TEMPLATES:
        ...
        if values.get("playbook") and not frappe.db.exists("SEI Playbook", values["playbook"]):
            values["playbook"] = None
        if values.get("thesis") and not frappe.db.exists("SEI Thesis", values["thesis"]):
            values["thesis"] = None
