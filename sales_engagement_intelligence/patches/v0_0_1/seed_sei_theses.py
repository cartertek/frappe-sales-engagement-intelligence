...
THESES = [
    {
        ...
        'description': 'Cartertek supports agencies that need senior engineering help, implementation depth, or overflow capacity without repositioning as staff augmentation.',
    ...
    },
    {
        ...
        'description': 'Cartertek helps recover stalled, fragile, or half-finished software projects and moves them toward a usable delivery path.',
    ...
    },
    {
        ...
        'description': 'Cartertek helps teams stabilize and improve software after a launch, migration, prototype, or public release exposes production issues.',
    ...
    },
    {
        ...
        'description': 'Cartertek provides outcome-focused engineering execution when a team needs progress before a full-time hire is found.',
    ...
    },
    {
        ...
        'description': 'Cartertek connects disconnected tools, internal processes, and data flows so day-to-day work becomes simpler and more reliable.',
    ...
    },
    {
        ...
        'description': 'Cartertek builds practical AI capabilities into real workflows rather than isolated demos or novelty automations.',
    ...
    },
    {
        ...
        'description': 'Cartertek hardens prototypes, demo apps, and vibe-coded projects so they are maintainable, reliable, and ready for real users.',
    ...
    },
    {
        ...
        'description': 'Cartertek gives buyers an expert technical review when they need clarity before deciding whether to fix, rebuild, or extend software.',
